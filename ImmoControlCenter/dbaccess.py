...
def test():
    ...
    li = db.getSollmieten3( "bucher_lothar", 2020 )

    dictlist = db.getMasterobjektButtomieten( 17, 2020 )
    print( dictlist )
    # summe = db.getMasterobjektJahresBruttomieteSumme( 17, 2021 )
    # print( summe )
    # x = db.getObjektStammdaten( )
    # print( x )
    # l = db.getSollmieten()
    # print( l )
