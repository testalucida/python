...
from generictable_stuff.generictableviewdialog import EditableTableViewWidget, CustomTableView
...
class GeschaeftsreisenView( IccView ):
    ...
    def _createToolBar( self, r:int=0 ):
        tbl = QHBoxLayout()
        self._layout.addLayout( tbl, r, 0, alignment=Qt.AlignLeft | Qt.AlignTop )
