...
from PySide6.QtWidgets import QWidget, QFormLayout, QComboBox, QApplication, QPushButton, QHBoxLayout, QDialog, \
    QSizePolicy
...
class GeschaeftsreiseEditView( QWidget ):
    ...
    def _createGui( self ):
        ...
        self._meZweck.setSizePolicy( QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding )
        l.addRow( "Zweck: ", self._meZweck )
        self._beUebernachtung.setSizePolicy( QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding )
