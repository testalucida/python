...
from PySide6.QtGui import Qt, QFont, QPalette
from PySide6.QtWidgets import QWidget, QGridLayout, QHBoxLayout, QApplication, QTextEdit, QFrame, QVBoxLayout
    ...
    class MasterView(QFrame):
        ...
        class DataView(QFrame):
            ...
            def _createGui(self):
                ...
                boxlay = QVBoxLayout()
                boxlay.setSpacing( 0 )
                ## PySide6 issue: boxlay.setMargin(0)
