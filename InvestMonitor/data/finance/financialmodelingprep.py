...
class FMP:
    def __init__( self ):
        ...
        self._url = "https://financialmodelingprep.com/stable/"
        # self._endpointHistoricalPrice = "historical-price-full/"
        self._endpointHistoricalPrice = "historical-price-eod/light/"
    ...
    def testHistoricalPricesByTicker( self, ticker:str, period=Period.oneYear ) -> TickerData:
        """
    ...
    def _createFrom( period:Period ) -> str:
        return "from=2024-10-01"

###########################################################################################################

def testHistoricalStockPriceDataApi():
    #url = "https://financialmodelingprep.com/stable/historical-price-eod/light?symbol=AAPL&from=2024-11-04&to=2025-02-04&apikey=554aa031d25c1457115803e9c2562cb8"
    url = "https://financialmodelingprep.com/stable/historical-price-eod/light?symbol=AAPL&apikey=554aa031d25c1457115803e9c2562cb8"
...
def testFMPhistPrices():
    ...
    fmp = FMP()
    td:TickerData = fmp.testHistoricalPricesByTicker( "WTEM.DE" )
    # print( td.ticker )
    # print( td.close )
    td.close.plot()
    plt.grid()
...
def testDividend():
    ...
    url = "https://financialmodelingprep.com/stable/dividends-calendar/IEDY.L?from=2023-01-01&to=2023-12-31&apikey=554aa031d25c1457115803e9c2562cb8"
    data = requests.get(url)
    print(data)
