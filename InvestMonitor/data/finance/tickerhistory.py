...
def test3():
    ...
    try:
        df = tick_hist.getTickerHistoriesByPeriod( ["IEDY.L", "SEDM.L"], Period.fiveDays, Interval.oneDay )
        #df = tick_hist.getTickerHistoriesByPeriod( ["EZTQ", "IEFV"], Period.fiveDays, Interval.oneMonth )
        series = df["Close"]
        series._plot()
        print( "fertig" )
