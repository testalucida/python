...
class IMonMenuBar( QMenuBar ):
    ...
    def __init__(self):
        ...
        self._actionExportDatabase = self._menuIMon.addAction( "Datenbank zum Server exportieren" )
        self._actionExportDatabase.triggered.connect( self.export_database.emit )
        self._menuIMon.addSeparator()
...
class MainWindow( QMainWindow ):
    ...
    def __init__( self ):
        ...
        self._menuBar.export_database.connect( self.export_database.emit )
        self._menuBar.undock_infopanel.connect( self.undock_infopanel.emit )
        self._menuBar.show_orders.connect( self.show_orders.emit )
        self._menuBar.show_sum_categories.connect(self.show_sum_categories.emit)
