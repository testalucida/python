    ...
    def getVerwalterData(self, verwalter_id: int):
        resp = self._session. \
            get(Server.SERVER + 'business.php?q=verwalter_data&id=' +
                str(verwalter_id) + '&user=' + self._user)
        data = self._getReadRetValOrRaiseException(resp)
    ...
    def getVeranlagungData(self, whg_id: int, vj: int) -> dict:
        resp = self._session. \
            get(Server.SERVER + 'business.php?q=veranl_data&id=' +
                str(whg_id) + '&vj=' + str(vj) + '&user=' + self._user)
...
############### Zeilen 47 und 49 ENDE ##################################################
    ...
    def insertAfaData(self, afa_dict):
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=insert_afa&user=' + self._user,
                 data=afa_dict)
    ...
    def updateAfaData(self, afa_dict):
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=update_afa&user=' + self._user,
                 data=afa_dict)
    ...
    def updateWhgVeranlagData(self, data: dict):
        ...
        """
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=update_whg_veranlag&user=' + self._user,
                 data=data)
    ...
    def insertMtlEinAus(self, mea_dict):
        ...
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=insert_mtl_ein_aus&user=' + self._user,
                 data=meadictcopy)
    ...
    def updateMtlEinAus(self, mea_dict):
        meadictcopy = self._getDictCopyIsoDate(mea_dict, 'gueltig_ab', 'gueltig_bis')
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=update_mtl_ein_aus&user=' + self._user,
                 data=meadictcopy)
    ...
    def terminateMtlEinAus(self, mea_id, gueltig_bis):
        ...
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=terminate_mtl_ein_aus&user=' + self._user,
                 data=d)
    ...
    def deleteMtlEinAus(self, mea_id):
        d = {'mea_id': mea_id}
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=delete_mtl_ein_aus&user=' + self._user, data=d)
    ...
    def insertSonstEinAus(self, sea_dict: dict):
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=insert_sonst_ein_aus&user=' + self._user,
                 data=sea_dict)
    ...
    def updateSonstEinAus(self, sea_dict):
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=update_sonst_ein_aus&user=' + self._user,
                 data=sea_dict)
    ...
    def deleteSonstEinAus(self, sea_id):
        ...
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=delete_sonst_ein_aus&user=' + self._user, data=delData)
    ...
    def insertGrundsteuer(self, gs_dict: dict):
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=insert_grundsteuer&user=' + self._user,
                 data=gs_dict)
    ...
    def updateGrundsteuer(self, gs_dict):
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=update_grundsteuer&user=' + self._user,
                 data=gs_dict)
    ...
    def deleteGrundsteuer(self, gs_id):
        ...
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=delete_grundsteuer&user=' + self._user,
                 data=delData)
    ...
    def insertRechnung(self, rg_dict):
        ...
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=insert_rechnung&user=' + self._user, data=rgdictcopy)
    ...
    def updateRechnung(self, rg_dict):
        rgdictcopy = self._getDictCopyIsoDate(rg_dict, 'rg_datum', 'rg_bezahlt_am')
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=update_rechnung&user=' + self._user,
                 data=rgdictcopy)
    ...
    def deleteRechnung(self, rg_id):
        ...
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=delete_rechnung&user=' + self._user, data=delData)
    ...
    def deleteWohnung(self, whg_id: int) -> None:
        ...
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=delete_wohnung&user=' + self._user, data=delData)
    ...
    def insertVerwalter(self, data:XVerwalter) -> None:
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=insert_verwalter&user=' + self._user,
                 data=data.getValuesAsDict())
    ...
    def updateVerwalter(self, data:XVerwalter) -> None:
        resp = self._session. \
            post(Server.SERVER + 'business.php?q=update_verwalter&user=' + self._user,
                 data=data.getValuesAsDict())
