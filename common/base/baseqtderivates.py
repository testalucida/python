...
from PySide6.QtCore import QDate, Qt, QAbstractTableModel, QRect, Signal, QSize, QMargins, QEvent, QObject, \
    QRegularExpression
from PySide6.QtGui import QDoubleValidator, QIntValidator, QFont, QGuiApplication, QStandardItemModel, QStandardItem, \
    QMouseEvent, QTextDocument, QIcon, QFontMetrics, QValidator, QCursor, QAction, QRegularExpressionValidator
from PySide6.QtWidgets import QDialog, QCalendarWidget, QVBoxLayout, QBoxLayout, QLineEdit, QGridLayout, QPushButton, \
    QHBoxLayout, QApplication, QListView, QComboBox, QLabel, QTextEdit, QCheckBox, QFrame, QWidget, QTabWidget, \
    QToolBar, QMenuBar, QStatusBar, QMessageBox, QLayout, QSizePolicy
...
class FloatEdit( BaseEdit ):
    class MyDoubleValidator(QValidator):
        def __init__(self):
    ...
    def __init__( self, parent=None, showNegativNumbersRed:bool=True, isReadOnly=False ):
        ...
        regex = QRegularExpression( r"[0-9]+,[0-9]+" ) ##r"^[-+]?[0-9]*\.?[0-9]*$" )
        regval = QRegularExpressionValidator(regex)
        self.setValidator( regval )
        # floatval = FloatEdit.MyDoubleValidator() # QDoubleValidator()
