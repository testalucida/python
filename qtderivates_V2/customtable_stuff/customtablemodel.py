...
class XBase( ABC ):
    """
    Basisklasse für alle Schnittstellenklassen
    """
    ...
    def setFromDict( self, valuedict:Dict ):
        d = self.__dict__
...
class XDict( XBase ):
    """
    Wrapper für ein Dictionary, das von einem SQL-Select-Stmt. ggf. zurückgeliefert wird,
    dort wo nicht mit Schnittstellenobjekten gearbeitet wird
    """
    def __init__( self, valuedict:Dict ):
        XBase.__init__( self )
        self._dict = valuedict
...
class CustomTableModel( QAbstractTableModel ):
    def __init__( self, rowList:List[XBase] ):
